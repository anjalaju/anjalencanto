...
import 'package:main_project/view/USER/catogories2/makeupartist/BridalMakeup.dart';
import 'package:main_project/view/USER/catogories2/makeupartist/GroomMakeup.dart';
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ListTile(
                          ...
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder:(context) => Bridalmakeups()));
                          },
                        ),
                      )
                    ],
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ListTile(
                          ...
                          iconColor: Color.fromRGBO(0, 0, 0, 1),
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder:(context) => Groommakeups()));
                          },
                        ),
                      )
                    ],
