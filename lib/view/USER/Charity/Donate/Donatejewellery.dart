...
class Donatejewellery extends StatefulWidget {
  const Donatejewellery({super.key});

  @override
  State<Donatejewellery> createState() => _LogaState();
}

class _LogaState extends State<Donatejewellery> {
