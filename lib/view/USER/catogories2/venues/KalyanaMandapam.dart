...
class Kalyanamandappam extends StatefulWidget {
  const Kalyanamandappam({super.key});

  @override
  State<Kalyanamandappam> createState() => _KalyanamandappamState();
}

class _KalyanamandappamState extends State<Kalyanamandappam> {
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Venues',
                  eventsubcategory: 'Klyana mandapam');
