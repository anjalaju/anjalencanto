...
class Smallfunction extends StatefulWidget {
  const Smallfunction({super.key});

  @override
  State<Smallfunction> createState() => _SmallfunctionState();
}
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  ...
                  eventsubcategory: 'Small Function/ Part halls');
