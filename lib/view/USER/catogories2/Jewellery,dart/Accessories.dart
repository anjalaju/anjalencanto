...
class Accessoriesjewellery extends StatefulWidget {
  const Accessoriesjewellery({super.key});

  @override
  State<Accessoriesjewellery> createState() => _AccessoriesjewelleryState();
}

class _AccessoriesjewelleryState extends State<Accessoriesjewellery> {
  bool visible = false;
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Jewellery and Accessories',
                  eventsubcategory: 'Accessories');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Jewellery and Accessories', 'Accessories'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
