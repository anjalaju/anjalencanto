...
class Jewelleryaccessories extends StatefulWidget {
  const Jewelleryaccessories({super.key});

  @override
  State<Jewelleryaccessories> createState() => _JewelleryaccessoriesState();
}

class _JewelleryaccessoriesState extends State<Jewelleryaccessories> {
  bool visible = false;
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Jewellery and Accessories', ' Jewellery'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
