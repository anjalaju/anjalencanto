...
class Preweddingshoott extends StatefulWidget {
  const Preweddingshoott({super.key});

  @override
  State<Preweddingshoott> createState() => _PreweddingshoottState();
}

class _PreweddingshoottState extends State<Preweddingshoott> {
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Pre wedding shoot',
                  eventsubcategory: 'pre wedding photograpers');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Pre wedding shoot', 'pre wedding photograpers'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
