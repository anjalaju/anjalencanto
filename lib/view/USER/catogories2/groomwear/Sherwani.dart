...
class Sherwani extends StatefulWidget {
  const Sherwani({super.key});

  @override
  State<Sherwani> createState() => _SherwaniState();
}

class _SherwaniState extends State<Sherwani> {
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Groom wear and accessories', 'Shervani'),
