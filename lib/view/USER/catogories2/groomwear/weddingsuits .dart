...
class Weddingsuits extends StatefulWidget {
  const Weddingsuits({super.key});

  @override
  State<Weddingsuits> createState() => _WeddingsuitsState();
}

class _WeddingsuitsState extends State<Weddingsuits> {
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Groom wear and accessories',
                  eventsubcategory:  'Wedding suits');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Groom wear and accessories',  'Wedding suits'),
