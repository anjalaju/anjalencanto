...
class Bridalmakeups extends StatefulWidget {
  const Bridalmakeups({super.key});

  @override
  State<Bridalmakeups> createState() => _BridalmakeupsState();
}

class _BridalmakeupsState extends State<Bridalmakeups> {
  bool visible = false;
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Makeup artist',
                  eventsubcategory: 'Bridal Makeup');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Makeup artist', 'Bridal Makeup'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
