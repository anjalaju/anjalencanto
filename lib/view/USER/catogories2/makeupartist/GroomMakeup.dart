...
class Groommakeups extends StatefulWidget {
  const Groommakeups({super.key});

  @override
  State<Groommakeups> createState() => _GroommakeupsState();
}

class _GroommakeupsState extends State<Groommakeups> {
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Makeup artist', 'Groom Makeup'),
