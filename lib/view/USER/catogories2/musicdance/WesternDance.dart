...
class WesternDance extends StatefulWidget {
  const WesternDance({super.key});

  @override
  State<WesternDance> createState() => _WesternDanceState();
}

class _WesternDanceState extends State<WesternDance> {
  bool visible = false;
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Music dance',
                  eventsubcategory: 'Western dance');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Music dance', 'Western dance'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
