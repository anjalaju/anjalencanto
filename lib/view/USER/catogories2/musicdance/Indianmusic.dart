...
class Indianmusic extends StatefulWidget {
  const Indianmusic({super.key});

  @override
  State<Indianmusic> createState() => _IndianmusicState();
}

class _IndianmusicState extends State<Indianmusic> {
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Music dance', 'indian music'),
