...
class Westermusic extends StatefulWidget {
  const Westermusic({super.key});

  @override
  State<Westermusic> createState() => _WestermusicState();
}

class _WestermusicState extends State<Westermusic> {
  bool visible = false;
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  ...
                  eventsubcategory: 'Western music');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Music dance', 'Western music'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
