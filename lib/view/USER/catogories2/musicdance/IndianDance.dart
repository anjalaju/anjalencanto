...
class Indiandance extends StatefulWidget {
  const Indiandance({super.key});

  @override
  State<Indiandance> createState() => _IndiandanceState();
}

class _IndiandanceState extends State<Indiandance> {
  bool visible = false;
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Music dance', 'indian dance'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
