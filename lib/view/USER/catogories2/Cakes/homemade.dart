...
class Homemadecakes extends StatefulWidget {
  const Homemadecakes({super.key});

  @override
  State<Homemadecakes> createState() => _HomemadecakesState();
}

class _HomemadecakesState extends State<Homemadecakes> {
  bool visible = false;
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Cakes',
                  eventsubcategory: 'home made cakes');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Cakes', 'home made cakes'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
