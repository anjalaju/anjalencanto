...
class Bakerycakes extends StatefulWidget {
  const Bakerycakes({super.key});

  @override
  State<Bakerycakes> createState() => _BakerycakesState();
}

class _BakerycakesState extends State<Bakerycakes> {
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Cakes', eventsubcategory: 'bakery cakes');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Cakes', 'bakery cakes'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
