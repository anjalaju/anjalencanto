...
class Travellerbus extends StatefulWidget {
  const Travellerbus({super.key});

  @override
  State<Travellerbus> createState() => _TravellerbusState();
}

class _TravellerbusState extends State<Travellerbus> {
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Transportation',
                  eventsubcategory: 'traveller');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Transportation', 'traveller'),
