...
class Weddingcards extends StatefulWidget {
  const Weddingcards({super.key});

  @override
  State<Weddingcards> createState() => _WeddingcardsState();
}

class _WeddingcardsState extends State<Weddingcards> {
  bool visible = false;
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory:  'Card makes',
                  eventsubcategory: 'wedding cards');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser( 'Card makes', 'wedding cards'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
