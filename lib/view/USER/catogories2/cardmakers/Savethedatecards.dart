...
class Savethedatecards extends StatefulWidget {
  ...
  @override
  State<Savethedatecards> createState() => _SavethedatecardsState();
}

class _SavethedatecardsState extends State<Savethedatecards> {
  bool visible = false;
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  ...
                  eventsubcategory: 'save the date');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser( 'Card makes','save the date'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
