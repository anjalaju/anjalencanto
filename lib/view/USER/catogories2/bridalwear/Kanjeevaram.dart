...
class Kanjivaaram extends StatefulWidget {
  const Kanjivaaram({super.key});

  @override
  State<Kanjivaaram> createState() => _KanjivaaramState();
}

class _KanjivaaramState extends State<Kanjivaaram> {
  bool visible = false;
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  ...
                  eventsubcategory:  'Kanjeevaram silk sarees');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Bridal wear and accssories',  'Kanjeevaram silk sarees'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
