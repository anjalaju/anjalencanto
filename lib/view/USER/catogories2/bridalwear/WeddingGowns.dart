...
class WeddingGowns extends StatefulWidget {
  const WeddingGowns({super.key});

  @override
  State<WeddingGowns> createState() => _WeddingGownsState();
}

class _WeddingGownsState extends State<WeddingGowns> {
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  ...
                  eventsubcategory:  'Wedding Gowns');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Bridal wear and accssories', 'Wedding Gowns'),
