...
class Bridallehankas extends StatefulWidget {
  const Bridallehankas({super.key});

  @override
  State<Bridallehankas> createState() => _BridallehankasState();
}

class _BridallehankasState extends State<Bridallehankas> {
  bool visible = false;
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory:'Bridal wear and accssories',
                  eventsubcategory:' Bridal lehengas');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Bridal wear and accssories', ' Bridal lehengas'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
