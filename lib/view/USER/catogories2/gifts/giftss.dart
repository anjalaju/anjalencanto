...
class Giftss extends StatefulWidget {
  const Giftss({super.key});

  @override
  State<Giftss> createState() => _GiftssState();
}

class _GiftssState extends State<Giftss> {
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Gift',
                  eventsubcategory:'gifts');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Gift', 'gifts'),
