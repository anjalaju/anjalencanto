...
class KurtiesSaries extends StatefulWidget {
  ...
  @override
  State<KurtiesSaries> createState() => _KurtiesSariesState();
}

class _KurtiesSariesState extends State<KurtiesSaries> {
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  ...
                  eventsubcategory: 'Kurties Sarees');
