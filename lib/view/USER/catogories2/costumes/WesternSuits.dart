...
class WesternSuits extends StatefulWidget {
  const WesternSuits({super.key});

  @override
  State<WesternSuits> createState() => _WesternSuitsState();
}

class _WesternSuitsState extends State<WesternSuits> {
  bool visible = false;
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory:  'Constumes',
                  eventsubcategory: 'Western Suites');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser( 'Constumes', 'Western Suites'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
