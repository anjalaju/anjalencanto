...
class Weddingplanners extends StatefulWidget {
  const Weddingplanners({super.key});

  @override
  State<Weddingplanners> createState() => _WeddingplannersState();
}

class _WeddingplannersState extends State<Weddingplanners> {
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory:'Planning And Dcro',
                  eventsubcategory: 'Wedding planeers');
              ...
              children: [
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    ...
                    StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Planning And Dcro', 'Wedding planeers'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
