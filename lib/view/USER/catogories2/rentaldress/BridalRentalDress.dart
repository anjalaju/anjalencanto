...
class BridalRentalDress extends StatefulWidget {
  const BridalRentalDress({super.key});

  @override
  State<BridalRentalDress> createState() => _BridalRentalDressState();
}

class _BridalRentalDressState extends State<BridalRentalDress> {
  bool visible = false;
      ...
      body: Column(
        children: [
          ...
          TextField(
            ...
            onTap: () {
              provider.allsearch(
                  eventmaincategory: 'Rental Dress',
                  eventsubcategory: 'Bridal Rendals');
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Rental Dress', 'Bridal Rendals'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
