...
class Othersnacks extends StatefulWidget {
  const Othersnacks({super.key});

  @override
  State<Othersnacks> createState() => _OthersnacksState();
}

class _OthersnacksState extends State<Othersnacks> {
  bool visible = false;
                ...
                Consumer<FunctionProvider>(
                  builder: (context, helper, child) {
                    return StreamBuilder(
                      stream:
                          helper.getEventprojectuser('Catering', 'Other snacks'),
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                            ConnectionState.waiting) {
                          return const Center(
