...
import 'package:main_project/view/USER/events/bridalshowerlist.dart';
import 'package:main_project/view/USER/homepage/bottomnav.dart';


class Bridalshowerpage extends StatefulWidget {
  const Bridalshowerpage({super.key});

  @override
  State<Bridalshowerpage> createState() => _BridalshowerpageState();
}

class _BridalshowerpageState extends State<Bridalshowerpage> {
  @override
        ...
        children: [
          ...
          Expanded(
            child: ListView.separated(
              shrinkWrap: true,
              itemCount: Bridalshowerlist.length,
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  child: Container(
                    ...
                    color: Bridalshowerlist[index]["Color"],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(
                                "${Bridalshowerlist[index]["Title"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              )
                              ,Bridalshowerlist[index]["subtitle"]==null?Text(""):
                                Text(
                                "${Bridalshowerlist[index]["subtitle"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              ),
                            ],
