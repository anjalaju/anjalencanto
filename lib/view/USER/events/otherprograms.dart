...
import 'package:main_project/view/USER/events/otherprogramslist.dart';
import 'package:main_project/view/USER/homepage/bottomnav.dart';

class Otherprogramspage extends StatefulWidget {
  const Otherprogramspage({super.key});

  @override
  State<Otherprogramspage> createState() => _OtherprogramspageState();
}

class _OtherprogramspageState extends State<Otherprogramspage> {
  @override
        ...
        children: [
          Expanded(
            child: ListView.separated(
              shrinkWrap: true,
              itemCount: Otherprogramlist.length,
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  child: Container(
                    ...
                    color: Otherprogramlist[index]["Color"],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                "${Otherprogramlist[index]["Title"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              ),
                              Otherprogramlist[index]["subtitle"] == null
                                  ? Text("")
                                  : Text(
                                      "${Otherprogramlist[index]["subtitle"]}",
                                      style: const TextStyle(
