...
import 'package:main_project/view/USER/catergories/costumes.dart';
...
import 'package:main_project/view/USER/events/birthdaylist.dart';
                ...
                return InkWell(
                  onTap: () {
                    switch (index) {
                      ...
                      case 6:
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => const Costumepage()));
                        break;
                      case 7:
                        Navigator.of(context).push(MaterialPageRoute(
                  ...
                  child: Container(
                    ...
                    color: Birthdaylist[index]["Color"],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(
                                "${Birthdaylist[index]["Title"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              )
                              ,Birthdaylist[index]["subtitle"]==null?Text(""):
                                Text(
                                "${Birthdaylist[index]["subtitle"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              ),
                            ],
