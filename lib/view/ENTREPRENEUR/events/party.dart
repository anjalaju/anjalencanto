...
import 'package:main_project/view/ENTREPRENEUR/events/partylist.dart';
import 'package:main_project/view/ENTREPRENEUR/homepage/bottomnav.dart';

class Entreparty extends StatefulWidget {
  const Entreparty({super.key});

  @override
  State<Entreparty> createState() => _EntrepartyState();
}

class _EntrepartyState extends State<Entreparty> {
  @override
        ...
        children: [
          ...
          Expanded(
            child: ListView.separated(
              shrinkWrap: true,
              itemCount: entrepartylist.length,
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  child: Container(
                    ...
                    color: entrepartylist[index]["Color"],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(
                                "${entrepartylist[index]["Title"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              )
                              ,entrepartylist[index]["subtitle"]==null?Text(""):
                                Text(
                                "${entrepartylist[index]["subtitle"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              ),
                            ],
