...
import 'package:main_project/view/ENTREPRENEUR/events/otherprogramslist.dart';
import 'package:main_project/view/ENTREPRENEUR/homepage/bottomnav.dart';


class Entreotherpro extends StatefulWidget {
  const Entreotherpro({super.key});

  @override
  State<Entreotherpro> createState() => _EntreotherproState();
}

class _EntreotherproState extends State<Entreotherpro> {
  @override
        ...
        children: [
          ...
          Expanded(
            child: ListView.separated(
              shrinkWrap: true,
              itemCount: entreotherprogramlist.length,
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  child: Container(
                    ...
                    color: entreotherprogramlist[index]["Color"],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(
                                "${entreotherprogramlist[index]["Title"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              )
                              ,entreotherprogramlist[index]["subtitle"]==null?Text(""):
                                Text(
                                "${entreotherprogramlist[index]["subtitle"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              ),
                            ],
                        ...
                        ClipRRect(
                          ...
                          child: Image.asset(
                            "${entreotherprogramlist[index]["Image"]}",
                            fit: BoxFit.fill,
                            height: 130,
                            width: 160,
