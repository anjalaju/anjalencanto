...
import 'package:main_project/view/ENTREPRENEUR/events/bridalshowerlist.dart';
import 'package:main_project/view/ENTREPRENEUR/homepage/bottomnav.dart';



class Entrebridalshower extends StatefulWidget {
  const Entrebridalshower({super.key});

  @override
  State<Entrebridalshower> createState() => _EntrebridalshowerState();
}

class _EntrebridalshowerState extends State<Entrebridalshower> {
  @override
        ...
        children: [
          ...
          Expanded(
            child: ListView.separated(
              shrinkWrap: true,
              itemCount: entrebridalshowerlist.length,
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  child: Container(
                    ...
                    color: entrebridalshowerlist[index]["Color"],
                      ...
                      children: [
                        Padding(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(
                                "${entrebridalshowerlist[index]["Title"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              )
                              ,entrebridalshowerlist[index]["subtitle"]==null?Text(""):
                                Text(
                                "${entrebridalshowerlist[index]["subtitle"]}",
                                style: const TextStyle(
                                    fontWeight: FontWeight.w500, fontSize: 20),
                              ),
                            ],
                        ...
                        ClipRRect(
                          ...
                          child: Image.asset(
                            "${entrebridalshowerlist[index]["Image"]}",
                            fit: BoxFit.fill,
                            height: 130,
                            width: 160,
