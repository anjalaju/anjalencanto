...
class Entrephyderabad extends StatefulWidget {
  const Entrephyderabad({super.key});

  @override
  State<Entrephyderabad> createState() => _EntrephyderabadState();
}

class _EntrephyderabadState extends State<Entrephyderabad> {
  // edit
        ...
        body: Consumer<FunctionProvider>(
          builder: (context, instance, child) {
            return StreamBuilder(
             ...
             'Catering',  'hyderabad Dishes', auth.currentUser!.uid),
