...
class Entrepwesterndish extends StatefulWidget {
  const Entrepwesterndish({super.key});

  @override
  State<Entrepwesterndish> createState() => _EntrepwesterndishState();
}

class _EntrepwesterndishState extends State<Entrepwesterndish> {
  // edit
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        'Catering', 'Western Dishes', auth.currentUser!.uid),
