...
class Entrepbiriyani extends StatefulWidget {
  const Entrepbiriyani({super.key});

  @override
  State<Entrepbiriyani> createState() => _EntrepbiriyaniState();
}

class _EntrepbiriyaniState extends State<Entrepbiriyani> {
  // edit
        ...
        body: Consumer<FunctionProvider>(
          builder: (context, instance, child) {
            return StreamBuilder(
             ...
             'Catering', 'Biriyani Dishes', auth.currentUser!.uid),
