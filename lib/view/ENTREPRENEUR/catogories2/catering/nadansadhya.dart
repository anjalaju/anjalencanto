...
class Entrepnadansadya extends StatefulWidget {
  const Entrepnadansadya({super.key});

  @override
  State<Entrepnadansadya> createState() => _EntrepnadansadyaState();
}

class _EntrepnadansadyaState extends State<Entrepnadansadya> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                          'Catering',  'Nadan Sadhya', auth.currentUser!.uid),
