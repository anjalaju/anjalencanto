...
class Entrepsnallfnss extends StatefulWidget {
  const Entrepsnallfnss({super.key});

  @override
  State<Entrepsnallfnss> createState() => _EntrepsnallfnssState();
}

class _EntrepsnallfnssState extends State<Entrepsnallfnss> {
  // edit
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     'Planning And Dcro', 'Small function Decor', auth.currentUser!.uid),
