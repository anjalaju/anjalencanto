...
class Entrepdecorr extends StatefulWidget {
  const Entrepdecorr({super.key});

  @override
  State<Entrepdecorr> createState() => _EntrepdecorrState();
}

class _EntrepdecorrState extends State<Entrepdecorr> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                'Planning And Dcro', 'Decarotors', auth.currentUser!.uid),
