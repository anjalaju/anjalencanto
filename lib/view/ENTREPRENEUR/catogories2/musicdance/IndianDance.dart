...
class Entrepindiandan extends StatefulWidget {
  const Entrepindiandan({super.key});

  @override
  State<Entrepindiandan> createState() => _EntrepindiandanState();
}

class _EntrepindiandanState extends State<Entrepindiandan> {
  // edit
    ...
    return Scaffold(
        ...
        body: Consumer<FunctionProvider>(
          builder: (context, instance, child) {
            ...
            'Music dance', 'indian dance', auth.currentUser!.uid),
