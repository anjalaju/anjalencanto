...
class Entrepwesternmus extends StatefulWidget {
  const Entrepwesternmus({super.key});

  @override
  State<Entrepwesternmus> createState() => _EntrepwesternmusState();
}

class _EntrepwesternmusState extends State<Entrepwesternmus> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                        'Music dance',  'Western music', auth.currentUser!.uid),
