...
class Entrepindianmus extends StatefulWidget {
  ...
  @override
  State<Entrepindianmus> createState() => _EntrepindianmusState();
}

class _EntrepindianmusState extends State<Entrepindianmus> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                        'Music dance','indian music', auth.currentUser!.uid),
