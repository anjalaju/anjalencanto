...
class Entrepfourstar extends StatefulWidget {
  const Entrepfourstar({super.key});

  @override
  State<Entrepfourstar> createState() => _EntrepfourstarState();
}

class _EntrepfourstarState extends State<Entrepfourstar> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                  'Venues','4star &abouve hotels', auth.currentUser!.uid),
