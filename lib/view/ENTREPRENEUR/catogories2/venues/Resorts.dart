...
class Entrepresorts extends StatefulWidget {
  const Entrepresorts({super.key});

  @override
  State<Entrepresorts> createState() => _EntrepresortsState();
}

class _EntrepresortsState extends State<Entrepresorts> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                  'Venues',  'Resorts', auth.currentUser!.uid),
