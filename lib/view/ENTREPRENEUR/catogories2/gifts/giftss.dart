...
class Entrepgifts extends StatefulWidget {
  const Entrepgifts({super.key});

  @override
  State<Entrepgifts> createState() => _EntrepgiftsState();
}

class _EntrepgiftsState extends State<Entrepgifts> {
  // edit
        ...
        body: Consumer<FunctionProvider>(
          builder: (context, instance, child) {
            return StreamBuilder(
             ...
             'Gift', 'gifts', auth.currentUser!.uid),
