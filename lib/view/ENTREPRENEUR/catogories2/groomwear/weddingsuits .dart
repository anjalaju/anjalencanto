...
class entrepwwedd extends StatefulWidget {
  const entrepwwedd({super.key});

  @override
  State<entrepwwedd> createState() => _entrepwweddState();
}

class _entrepwweddState extends State<entrepwwedd> {
  // edit
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Consumer<FunctionProvider>(
         ...
         'Groom wear and accessories', 'Wedding suits', auth.currentUser!.uid),
