...
class Entrepkurta extends StatefulWidget {
  const Entrepkurta({super.key});

  @override
  State<Entrepkurta> createState() => _EntrepkurtaState();
}

class _EntrepkurtaState extends State<Entrepkurta> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                'Groom wear and accessories', 'Kurtha', auth.currentUser!.uid),
