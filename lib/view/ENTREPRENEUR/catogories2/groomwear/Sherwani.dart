...
class Entrepsherwani extends StatefulWidget {
  ...
  @override
  State<Entrepsherwani> createState() => _EntrepsherwaniState();
}

class _EntrepsherwaniState extends State<Entrepsherwani> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                  'Groom wear and accessories', 'Shervani', auth.currentUser!.uid),
