...
class Entrepprewedding extends StatefulWidget {
  const Entrepprewedding({super.key});

  @override
  State<Entrepprewedding> createState() => _EntreppreweddingState();
}

class _EntreppreweddingState extends State<Entrepprewedding> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                    'Pre wedding shoot', 'pre wedding photograpers', auth.currentUser!.uid),
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return SizedBox(
                    ...
                    child: Center(child: Image.asset('images/event.jpeg')),
                  );
                }
                if (snapshot.hasData) {
                  return SingleChildScrollView(
