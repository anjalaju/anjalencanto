...
class Entrepkanjee extends StatefulWidget {
  const Entrepkanjee({super.key});

  @override
  State<Entrepkanjee> createState() => _EntrepkanjeeState();
}

class _EntrepkanjeeState extends State<Entrepkanjee> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                           'Bridal wear and accssories','Kanjeevaram silk sarees', auth.currentUser!.uid),
