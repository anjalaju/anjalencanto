...
class Entrepphotographers extends StatefulWidget {
  ...
  @override
  State<Entrepphotographers> createState() => _EntrepphotographersState();
}

class _EntrepphotographersState extends State<Entrepphotographers> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                  'Photograpers', 'Photographersd', auth.currentUser!.uid),
