...
class Entrepjellacce extends StatefulWidget {
  ...
  @override
  State<Entrepjellacce> createState() => _EntrepjellacceState();
}

class _EntrepjellacceState extends State<Entrepjellacce> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                          'Jewellery and Accessories', ' Jewellery', auth.currentUser!.uid),
