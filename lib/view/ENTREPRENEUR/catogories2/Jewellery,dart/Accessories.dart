...
class Entrepaccesjull extends StatefulWidget {
  const Entrepaccesjull({super.key});

  @override
  State<Entrepaccesjull> createState() => _EntrepaccesjullState();
}

class _EntrepaccesjullState extends State<Entrepaccesjull> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                    'Jewellery and Accessories', 'Accessories', auth.currentUser!.uid),
