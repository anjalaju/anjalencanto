...
class Entrepbridmake extends StatefulWidget {
  ...
  @override
  State<Entrepbridmake> createState() => _EntrepbridmakeState();
}

class _EntrepbridmakeState extends State<Entrepbridmake> {
  // edit
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      'Bridal Makeup',
        ...
        'Makeup artist','Bridal Makeup', auth.currentUser!.uid),
