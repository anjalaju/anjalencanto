...
class Entrepkurties extends StatefulWidget {
  const Entrepkurties({super.key});

  @override
  State<Entrepkurties> createState() => _EntrepkurtiesState();
}

class _EntrepkurtiesState extends State<Entrepkurties> {
  @override
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  builder: (context) => EntreChatpage(name: 'Kurties & Saries',),
                ));},
                        child: const Row(
                          children: [
                            Icon(Icons.message),
