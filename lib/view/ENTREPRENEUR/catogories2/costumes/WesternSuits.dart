...
class Entrepwestsuits extends StatefulWidget {
  const Entrepwestsuits({super.key});

  @override
  State<Entrepwestsuits> createState() => _EntrepwestsuitsState();
}

class _EntrepwestsuitsState extends State<Entrepwestsuits> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                  'Constumes', 'Western Suites', auth.currentUser!.uid),
