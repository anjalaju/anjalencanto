...
class Entrepotherfns extends StatefulWidget {
  const Entrepotherfns({super.key});

  @override
  State<Entrepotherfns> createState() => _EntrepotherfnsState();
}

class _EntrepotherfnsState extends State<Entrepotherfns> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                 'Card makes',  'other function cards', auth.currentUser!.uid),
