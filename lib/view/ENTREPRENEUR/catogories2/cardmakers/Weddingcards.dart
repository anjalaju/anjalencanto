...
class Entrepweddingcards extends StatefulWidget {
  const Entrepweddingcards({super.key});

  @override
  State<Entrepweddingcards> createState() => _EntrepweddingcardsState();
}

class _EntrepweddingcardsState extends State<Entrepweddingcards> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                         'Card makes',  'wedding cards', auth.currentUser!.uid),
