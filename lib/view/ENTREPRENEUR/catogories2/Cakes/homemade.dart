...
class Entrephomemade extends StatefulWidget {
  const Entrephomemade({super.key});

  @override
  State<Entrephomemade> createState() => _EntrephomemadeState();
}

class _EntrephomemadeState extends State<Entrephomemade> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                             'Cakes', 'home made cakes', auth.currentUser!.uid),
