...
class Entrepbakerycakes extends StatefulWidget {
  const Entrepbakerycakes({super.key});

  @override
  State<Entrepbakerycakes> createState() => _EntrepbakerycakesState();
}

class _EntrepbakerycakesState extends State<Entrepbakerycakes> {
  // edit
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        'Cakes', 'bakery cakes', auth.currentUser!.uid),
