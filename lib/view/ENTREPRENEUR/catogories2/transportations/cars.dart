...
class Entrepcars extends StatefulWidget {
  const Entrepcars({super.key});

  @override
  State<Entrepcars> createState() => _EntrepcarsState();
}

class _EntrepcarsState extends State<Entrepcars> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                                  'Transportation', 'car', auth.currentUser!.uid),
