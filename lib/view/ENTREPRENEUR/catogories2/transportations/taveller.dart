...
class Entreptravveller extends StatefulWidget {
  ...
  @override
  State<Entreptravveller> createState() => _EntreptravvellerState();
}

class _EntreptravvellerState extends State<Entreptravveller> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                  'Transportation', 'traveller', auth.currentUser!.uid),
