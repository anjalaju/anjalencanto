...
class Entrepmehndi extends StatefulWidget {
  const Entrepmehndi({super.key});

  @override
  State<Entrepmehndi> createState() => _EntrepmehndiState();
}

class _EntrepmehndiState extends State<Entrepmehndi> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                    'Mehandi artist', 'Mehandhi artist', auth.currentUser!.uid),
