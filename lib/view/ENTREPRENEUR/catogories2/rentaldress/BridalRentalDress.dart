...
class Entrepbridalrent extends StatefulWidget {
  ...
  @override
  State<Entrepbridalrent> createState() => _EntrepbridalrentState();
}

class _EntrepbridalrentState extends State<Entrepbridalrent> {
  // edit
          ...
          builder: (context, instance, child) {
            return StreamBuilder(
              stream: instance.getEventproject(
                  'Rental Dress', 'Bridal Rendals', auth.currentUser!.uid),
