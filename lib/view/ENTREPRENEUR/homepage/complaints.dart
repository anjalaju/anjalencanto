                    ...
                    builder: (context, snapshot) {
                      ...
                      if(snapshot.hasData){
                        ...
                        itemBuilder: (context, index) {
                            ...
                            final userdata=db.collection('firebase').doc(doc).snapshots();
                            ...
                            child:   Padding(
                              ...
                              child: Column(
                                children: [
                                 ...
                                 StreamBuilder(stream: userdata, builder: (context, snapshot) {
                                   if(snapshot.connectionState==ConnectionState.waiting){
                        return Center(child: CircularProgressIndicator(),);
                      }
                                   return Column(
                                     children: [
                                       Text('Complaint Name ${snapshot.data!['User_Name']}'),
                                        Text('Complaint phonenumber  ${snapshot.data!['Mobile_No']}'),
