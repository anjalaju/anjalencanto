...
class Entreloginnotification extends StatefulWidget {
  const Entreloginnotification({super.key});

  @override
  State<Entreloginnotification> createState() => _EntreloginnotificationState();
}

class _EntreloginnotificationState extends State<Entreloginnotification> {
  @override
