...
class EntreDonatejewellery extends StatefulWidget {
  const EntreDonatejewellery({super.key});

  @override
  State<EntreDonatejewellery> createState() => _LogaState();
}

class _LogaState extends State<EntreDonatejewellery> {
