...
// class EntreDonateaccessories extends StatefulWidget {
...
class EntreDonateaccessories extends StatefulWidget {
  const EntreDonateaccessories({super.key});

  @override
  State<EntreDonateaccessories> createState() => _LogaState();
}

class _LogaState extends State<EntreDonateaccessories> {
  ...
  final selectedvalue = 'DonatedAccsesies';
